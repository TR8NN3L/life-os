...
const TUT_STEPS = [
  ...
  },
  {
    ...
    body: "Jede Task hat einen eingebauten Stoppuhr. Klick auf 'START →' — der Timer startet und du wechselst in den Fokusmodus: eine Aufgabe, volle Konzentration, null Ablenkung.",
    hint: "Klick auf 'START →' bei der Tutorial-Task.",
    position: "bottom", blockClicks: true,
  },
  {
    id: "focus-intro", route: "focus", selector: "[data-tutorial='focus-canvas']", type: "explain",
    title: "Fokusmodus",
    body: "Schwarz, still, eine Aufgabe. Alles andere fällt weg. Der Reality Tracker misst deine echte Arbeitszeit — diese Daten fließen direkt in deine Insights ein. Starte den Timer unten.",
    position: "corner", blockClicks: false,
  },
  {
    id: "focus-start", route: "focus", selector: "[data-tutorial='focus-start-btn']", type: "do",
    waitFor: "timer-started",
    title: "Reality Tracker starten",
    body: "Drück den großen Button — der Timer läuft. So sammelst du echte Daten über deine Arbeitszeit.",
    hint: "Großen START-Button drücken.",
    position: "corner", blockClicks: true,
  },
  {
    id: "focus-back", route: "focus", selector: "[data-tutorial='exit-focus-btn']", type: "do",
    waitFor: "route-dashboard",
    title: "Zurück zum Dashboard",
    body: "Gut. Du hast den Fokusmodus erlebt. Klick auf '← EXIT FOCUS' oder drück ESC um zurückzukehren.",
    hint: "'← EXIT FOCUS' klicken oder ESC drücken.",
