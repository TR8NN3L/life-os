...
const TUT_STEPS = [
  ...
  {
    id: "task-timer", route: "dashboard", forcePov: "personal",
    selector: "[data-tutorial='task-start-btn']",
  ...
  },
  {
    ...
    body: "Fokusmodus beendet. Klick auf '← EXIT FOCUS' oder drück ESC um zurückzukehren.",
